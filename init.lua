...
-- Tab configuration: one tab equals 4 spaces
vim.opt.tabstop = 4
...
vim.keymap.set('n', '<M-k>', '<CMD>cprev<CR>', { desc = 'Next quickfix' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Use custom grep in config/telescope/multigrep
  ...
  },
  {
    ...
    config = function()
      ...
      -- Manually setup servers that are not managed by Mason
      for server_name, server_config in pairs(servers) do
        if server_config.mason == false then
          -- Extend capabilities even for manual setup
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'c_sharp', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'razor', 'query', 'vim', 'vimdoc' },
